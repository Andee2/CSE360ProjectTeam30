...
{	
	...
	private JButton backButton, giveUpButton, rankButton, createButton, chooseButton, battleButton, 
		createProfileButton, rollButton, empty, empty2, empty3, empty4;//, loadProfileButton;
...
/*========================================[DECLARATION]========================================*/
		...
		loadProfilePanel.add(createTextField);
		loadProfilePanel.add(chooseButton);
	...
	private class ButtonListener implements ActionListener
	{
		public void actionPerformed(ActionEvent event) {
			...
			if (action == chooseButton)
			{
				...
				String insertedPlayer;
				insertedPlayer = createTextField.getText();
				Player newPlayer = new Player();
				newPlayer = IO.retrieve(insertedPlayer);
